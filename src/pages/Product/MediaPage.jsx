            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="w-full mx-auto">
                ...
                <div className="py-5 px-2">
                  <Link
                    to={"/booking"}
                    className="mb-3 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#4441D5] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Session
                    <svg
                      aria-hidden="true"
                  ...
                  <p className="font-normal text-gray-700">Description 1.</p>
                </div>
              </div>

              <div className="w-full mx-auto">
                <Link>
                  <img className="rounded-sm" src={logo1} alt="" />
                </Link>
                <div className="py-5 px-2">
                  <Link className="mb-3 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#4441D5] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Session
                    <svg
                      aria-hidden="true"
                      className="w-4 h-4 ml-2 -mr-1"
              ...
              <div className="w-full mx-auto">
                <Link>
                  <img className="rounded-sm" src={logo2} alt="" />
                </Link>
                <div className="py-5 px-2">
                  <Link className="mb-3 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#4441D5] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Session
              ...
              <div className="w-full mx-auto">
                <Link>
                  <img className="rounded-sm" src={logo3} alt="" />
                </Link>
                <div className="py-5 px-2">
                  <Link className="mb-3 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#4441D5] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Session
